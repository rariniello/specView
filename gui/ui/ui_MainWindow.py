...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.averageKLabel.setText(_translate("MainWindow", "Shots to Average"))
        self.takeBackgroundButton.setText(_translate("MainWindow", "Take Background"))
        self.exp4Button.setText(_translate("MainWindow", "1000"))
        self.backgroundLabel.setText(_translate("MainWindow", "Background Shots"))
        self.label.setText(_translate("MainWindow", "Select Spectrometer"))
        self.subtractBackgroundCheck.setText(_translate("MainWindow", "Subtract Background"))
        self.showBackgroundCheck.setText(_translate("MainWindow", "Show Background"))
        self.saveButton.setText(_translate("MainWindow", "..."))
        self.averageShotsCheck.setText(_translate("MainWindow", "Average Shots"))
        self.exp1Button.setText(_translate("MainWindow", "1"))
        self.exp2Button.setText(_translate("MainWindow", "10"))
        self.startButton.setText(_translate("MainWindow", "..."))
        self.exposureLabel.setText(_translate("MainWindow", "Exposure Time (ms)"))
        self.exp3Button.setText(_translate("MainWindow", "100"))
